...
# in
{
  ...
  programs.zotero = {
    ...
    profiles.default = {
      ...
      #   "pubpeer@pubpeer.com" = "24c9ee35-6c06-4a3e-b296-185259e0348b";
      #   "zoteropreview@carter-tod.com" =
      #     "f4ff7c18-9extensions.webextensions.uuids469-4524-a768-88e8fa5a7e35";
      #   "date-from-last-modified@iris-advies.com" = "7e23c773-e4a6-41e1-9643-feeb3b6d5cf6";
      #   "zutilo@www.wesailatdawn.com" = "a1c7f1c0-1bb5-4d55-8d38-648ac7f1e3fc";
      # };
